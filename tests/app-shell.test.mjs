...
test("提醒规则保存入口受保护并复用 settings service", () => {
  ...
  assert.match(reminderRuleFormSource, /reminderHourOptions/);
  assert.match(reminderRuleFormSource, /reminderMinuteOptions/);
  assert.match(reminderRuleFormSource, /name="reminderHour"/);
  assert.match(reminderRuleFormSource, /name="reminderMinute"/);
  assert.match(saveReminderRuleActionSource, /reminderHour/);
  assert.match(saveReminderRuleActionSource, /reminderMinute/);
